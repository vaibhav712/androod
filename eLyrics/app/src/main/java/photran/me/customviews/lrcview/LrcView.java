...
public class LrcView extends View implements ILrcView{
	...
	private int mNormalRowColor = Color.parseColor("#7f8c8d");
	private int mSeekLineColor = Color.parseColor("#3498db");
	private int mSeekLineTextColor = Color.parseColor("#3498db");
